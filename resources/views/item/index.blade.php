                ...
                <td>
                  <div class="btn-group" role="group">
                    ...
                    <form class="btn-group" action="{{ action('ItemController@destroy', $item) }}" method="POST">
                      ...
                      <a href="{{ action('ItemController@stock', ['id' => $item, 'action' => 'add'] ) }}" class="btn btn-success"> + </a>
                      <a href="{{ action('ItemController@stock', ['id' => $item, 'action' => 'remove'] ) }}" class="btn btn-success"> - </a>
